            ...
            <div class="row">
                <div class="col-lg-12 mb-lg-0 mb-4 shadow-xl">
                    <div class="card p-2">
                        ...
                        <form class="p-3" method="POST" action="{{ route('ambil_kuliah.update', ['NRP' => $ambilKuliah->NRP, 'IDMK' => $ambilKuliah->IDMK]) }}" enctype="multipart/form-data">
                        @csrf 
                        @method('PUT') 
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="exampleFormControlInput1"
                                            value="{{$ambilKuliah->NRP}}" disabled name="NRP">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label>IDMK</label>
                                        <input type="text" class="form-control" id="exampleFormControlInput1"
                                            value="{{$ambilKuliah->IDMK}}" disabled name="IDMK">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="exampleFormControlInput1"
                                            value="{{$ambilKuliah->NamaMK}}" name="NilaiAngka">
                                    </div>
                                </div>
                            </div>
